            ...
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
                        <span className='text-slate-500'>Brochure </span>
                ...
                <span class="block text-sm sm:text-center text-slate-700">© 2024 <a href="#" class="hover:underline">Brochure™</a>. All Rights Reserved.</span>
            </div>
        </footer>
  )
}
